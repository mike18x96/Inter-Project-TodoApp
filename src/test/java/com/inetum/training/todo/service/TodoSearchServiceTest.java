...
import com.inetum.training.entity.todo.repository.specyfication.TodoSpecifications;
...
public class TodoSearchServiceTest {
    ...
    public void searchByParams_searchByNameOnly_returnsElementFoundInRepo(List<Todo> expectedTodo, List<TodoDtoWithoutUser> expectedTodoDto, String generateName) {
        ...
        //when
        Page<TodoDtoWithoutUser> todoPage = todoSearchService.searchByParams(specification, pageable);
        //then

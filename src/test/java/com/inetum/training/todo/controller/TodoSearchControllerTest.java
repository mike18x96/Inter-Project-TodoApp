...
import com.inetum.training.entity.todo.controller.TodoSearchController;
...
class TodoSearchControllerTest {
    ...
    @BeforeEach
    public void setUp() {
        mockMvc = standaloneSetup(new TodoSearchController(searchService, loggedCurrentUser))
